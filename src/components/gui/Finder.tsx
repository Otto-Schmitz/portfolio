...
export function Finder() {
  ...
  return (
    <div className="w-full max-w-[min(1100px,96vw)] h-[min(780px,85vh)] sm:h-[min(780px,82vh)] flex flex-col shrink-0 rounded-lg sm:rounded-xl overflow-hidden bg-white dark:bg-zinc-800 border border-black/10 dark:border-zinc-600">
      <WindowChrome title={t("gui_window_title")} />
      <div className="flex flex-1 min-h-0 min-w-0">
        <aside
          className="w-36 sm:w-48 shrink-0 border-r border-zinc-200 dark:border-zinc-600 bg-zinc-50/80 dark:bg-zinc-800/80 p-2 overflow-y-auto finder-sidebar-scroll"
        ...
        <section
          className="flex-1 min-w-0 p-3 sm:p-4 bg-white dark:bg-zinc-800 overflow-y-auto finder-content-scroll"
          aria-label="Content"
        >
          {openSection ? (
